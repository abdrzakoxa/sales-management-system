<form class="f-row form-style expenses-categories-edit" method="post" autocomplete="off">
    ...
    <div class="input-group-s col-md-down-1 col-md-up-2">
        ...
        <input type="text" name="type" value="{ ExpenseCategory->Type }" min="3" max="25"  data-pattern="^[A-z \u0600-\u06FF]{3,25}$" >
    </div>

    <div class="input-group-s col-md-down-1 col-md-up-2">
        <label >{ label_fixed_payment }</label>
        <input type="text" name="fixedPayment" value="@currency_input (#ExpenseCategory->FixedPayment)" min="0" max="10"  data-pattern="^[0-9]+(\.[0-9]{1,8})?$" >
    </div>
